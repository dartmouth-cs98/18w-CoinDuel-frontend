...
class LoginViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        // use facebook
        self.useFacebookButton.layer.masksToBounds = true
        self.useFacebookButton.layer.cornerRadius = 3
        self.useFacebookButton.layer.borderColor = UIColor(red:1, green:1, blue:1, alpha:0.8).cgColor
        self.useFacebookButton.layer.borderWidth = 0.75
